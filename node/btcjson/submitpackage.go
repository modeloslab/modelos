...
// response. Values are in PRL. May be omitted if fee info is not applicable.
type JsonSubmitPackageFees struct {
	// Base is the absolute fee of this specific transaction (in PRL).
	Base float64 `json:"base"`

	// EffectiveFeeRate (Optional, PRL/kvB): The transaction's effective
