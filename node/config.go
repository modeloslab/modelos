...
type config struct {
	...
	MinPeerVersion           string        `long:"minpeerversion" description:"Override the built-in enforced minimum modelosd version for full-node peers (default enforced; raise it here, e.g. '1.0.8', or set '0'/'none' to disable). Only gates peers whose user-agent contains 'modelosd:'; SPV/light clients (neutrino) and other agents are unaffected."`
