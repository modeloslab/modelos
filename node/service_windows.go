...
const (
	...
	svcDesc = "Downloads and stays synchronized with the Pearl blockchain " +
		"and provides chain services to applications."
)

// elog is used to send messages to the Windows event log.
var elog *eventlog.Log

// logServiceStartOfDay logs information about pearld when the main server has
...
// installService attempts to install the pearld service.  Typically this should
...
// removeService attempts to uninstall the pearld service.  Typically this should
...
// startService attempts to start the pearld service.
...
func serviceMain() (bool, error) {
	...
	// needed to run pearld on Windows in CI environments like Travis.
