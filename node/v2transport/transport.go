...
// PearlNet is a type used to represent the Pearl network that we're
// connecting to.
//
// NOTE: This is identical to the wire.PearlNet type, but allows us to shed a
...
func (p *Peer) createV2Ciphers(ecdhSecret []byte, initiating bool,
	...
	// Define the salt as the string "pearl_v2_shared_secret" followed by
	// the PearlNet's "magic" bytes.
	salt := []byte("pearl_v2_shared_secret")
